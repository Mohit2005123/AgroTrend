...
export default function ProductOverview() {
  return (
    <section className="product-overview py-12 px-6 md:py-24 md:px-12 bg-white">
      <div className="container mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-8">Product Overview</h2>
...
function FeatureCard({ feature }) {
  return (
    <div
      className="feature-item bg-gray-100 p-6 rounded-lg shadow-md transform transition-transform duration-500 hover:scale-105 hover:shadow-xl hover:rotate-2"
    >
