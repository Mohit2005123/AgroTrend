...
export default function Features() {
  return (
    <section className="features py-12 px-6 md:py-24 md:px-12 bg-gray-100">
...
function FeatureCard({ feature }) {
  ...
  return (
    <div
      ref={ref}
      className={`feature-item bg-white p-6 rounded-lg shadow-md transform transition duration-1000 ease-out ${
        inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
      }`}
    >
      <div className="feature-icon mb-4 text-green-600">{feature.icon}</div>
