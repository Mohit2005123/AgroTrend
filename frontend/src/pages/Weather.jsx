        ...
        <div className="max-w-3xl mx-auto my-8 p-6 bg-gray-800 shadow-lg rounded-lg relative">
          <div className="mb-6">
            <input
              ...
              className="p-3 border border-gray-700 rounded-lg w-full bg-gray-900 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-600 transition"
            ...
            <button
              ...
              className="mt-4 p-3 bg-green-600 text-white rounded-lg hover:bg-green-500 transition ease-in-out duration-300"
            >
              Get Weather
            </button>
            {showSuggestions && suggestions.length > 0 && (
              <ul className="absolute left-0 right-0 mt-2 bg-gray-800 border border-gray-700 rounded-lg z-10">
